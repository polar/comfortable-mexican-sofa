module ComfortableMexicanSofa::MongoMapper::HasRevisions
  ...
  module ClassMethods
    ...
    def cms_has_revisions_for(*fields)
      ...
      include ComfortableMexicanSofa::MongoMapper::HasRevisions::InstanceMethods
  ...
  module InstanceMethods
    ...
    def create_revision
      ...
      self.revisions.where(:id.nin => ids).all.each do |r|
        r.destroy()
      end
    end
